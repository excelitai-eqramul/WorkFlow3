            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="card" style="height: 270px; width:300px">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('update.department') }}" class="form form-vertical">
                                @csrf
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <input type="text" id="first-name-icon" class="form-control"
                                                    name="name" value="{{ $department_edit->name }}"
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="input-group input-group-merge">
                                                <select class="form-select form-select" id="selectLarge" name="parent_id"
                                                    value="{{ $department_edit->parent_id }}">
                                    ...
                                    <div class="col-12">
                                        <button type="submit"
                                            class="btn btn-primary me-1 waves-effect waves-float waves-light mt-2">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
